 ...
 */
require_once ABS_PATH_ADMIN . '/TGM-Plugin-Activation-2.6.1/class-tgm-plugin-activation.php';
...
function tb_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Bears Shortcodes',
            'slug'               => 'bears_shortcodes',
            'source'             => $root .'bears_shortcodes/bears_shortcodes_v1.1.2.zip',
            'required'           => true,
        ),
        array(
            'name'               => 'Lemon Grid',
        ...
        array(
            'name'               => 'TB Donations',
            'slug'               => 'tbdonations',
            'source'             => $root .'tbdonations/tbdonations_v1.1.zip',
            'required'           => true,
        ),
        array(
