<?php
class BearsthemesFrameworkMetaboxes {
	...
	public function add_meta_boxes()
	{
		...
		$this->add_meta_box('post_options', __('Page Options','bearsthemes'), 'page');
		$this->add_meta_box('post_video', __('Video Settings','bearsthemes'), 'post');
		$this->add_meta_box('post_audio', __('Audio Settings','bearsthemes'), 'post');
		$this->add_meta_box('post_quote', __('Quote Settings','bearsthemes'), 'post');
		$this->add_meta_box('post_link', __('Link Settings','bearsthemes'), 'post');
		$this->add_meta_box('post_team', __('Team Settings','bearsthemes'), 'team');
		$this->add_meta_box('post_story', __('Story Settings','bearsthemes'), 'story');
	}
...
$metaboxes = new BearsthemesFrameworkMetaboxes();