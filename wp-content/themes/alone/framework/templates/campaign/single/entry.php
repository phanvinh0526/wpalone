<?php
/**
 * bearsthemes_campaignSingleRender
 *
 */
if( ! function_exists( 'bearsthemes_campaignSingleRender' ) ) :
	function bearsthemes_campaignSingleRender()
	{
		...
		<article id="post-<?php echo esc_attr( $post->ID ); ?>" <?php post_class(); ?>>
			<div class="bears-campaign-item campaign-temp-default campaign-format-<?php echo esc_attr( basename( __FILE__, '.php' ) ); ?>">
...
echo bearsthemes_campaignSingleRender();
?>