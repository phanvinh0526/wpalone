...
if ( !class_exists( 'Radium_Theme_Importer' ) ) {
  ...
  class Radium_Theme_Importer {
     ...
     * @since 2.2.0
     *
     * @param string  $file Path to .json file uploaded
    ...
    public function import_widgets( $data ) {
      // clear widget current
      clear_widgets();

      // import widget data
      $bears_import_results = bears_import_widget_data( $data );

      // return
      return $bears_import_results;
    }
  }//class
}//function_exists
 ...
 * @return array Results array
 */
function bears_import_widget_data( $data ) {
  ...
  $available_widgets = bears_available_widgets();
 ...
 * @return array Widget information
 */
function bears_available_widgets() {
