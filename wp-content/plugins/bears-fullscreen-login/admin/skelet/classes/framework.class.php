  ...
  class SkeletFramework extends SkeletFramework_Abstract {
    ...
    public function admin_menu() {
      ...
      $defaults_menu_args = array(
		...
		call_user_func("add_menu_page", $args['menu_title'], "Fullscreen Login", $args['menu_capability'], $args["menu_slug"], array( &$this, 'admin_page' ), $args['menu_icon'], $args['menu_position'] );
    ...
    public function admin_page() {
      ...
      echo '<div class="sk-framework sk-option-framework">';
        ...
        echo sprintf('%s',
            ...
            //$this->settings['header_title']." <small>".$this->settings['current_version']."</small>":"Skelet Framework <small>by Bears</small>"); 
      ...
      /* echo '<footer class="sk-footer">';
        ...
        echo '<a target="_blank" href="http://bearsthemes.com/"><img src="' . $skelet_path["uri"] . '/assets/images/bears.png"></a>';
