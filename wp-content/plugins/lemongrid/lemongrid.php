...
class LemonGrid
{
	...
	{	
		 ...
		 * Lib JS Lodash
		 */
		wp_register_script( 'lodash', TBLG_JS . 'lodash.min.js', array(), '1.0', true );

		/**
		 * Lib JS Gridstack
		 */
		wp_register_script( 'gridstack', TBLG_JS . 'gridstack.js', array( 'jquery', 'lodash' ), '1.0', true );
		wp_register_style( 'gridstack', TBLG_CSS . 'gridstack.css', array(), '1.0' );

		/**
		 * Lib JS Dynamics
		 */
		wp_register_script( 'dynamics', TBLG_JS . 'dynamics.min.js', array(), '1.0', true );

		/**
		 * Lib ICON 
		 */
		wp_register_style( 'font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css', array(), '1.0', true );
		wp_register_style( 'ionicon', TBLG_CSS . 'ionicons.min.css', array(), '1.0' );

		/**
		 * Script LemonGrid
		 */
		wp_register_script( 'tb-lemongrid-script', TBLG_JS . 'lemongrid.js', array( 'jquery', 'gridstack' ), '1.0', true );
		wp_register_style( 'tb-lemongrid-script', TBLG_CSS . 'lemongrid.css', array(), '1.0' );
	}
