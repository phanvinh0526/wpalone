...
/* Autoupdate */
require TBBS_INCLUDES . 'plugin-update-checker-3.1/plugin-update-checker.php';
$BCoreUpdateChecker = PucFactory::buildUpdateChecker( 'http://theme.bearsthemes.com/autoupdate/plugins/bears_shortcodes/update-info.json', __FILE__ );
